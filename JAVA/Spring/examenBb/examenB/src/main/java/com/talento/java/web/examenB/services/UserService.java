package com.talento.java.web.examenB.services;
...
import com.talento.java.web.examenB.repositories.UserRepository;
...
public class UserService {
    ...
    public User registerUser(User user) {
        String hashed = BCrypt.hashpw(user.getPassword(), BCrypt.gensalt());//aca está encriptando el password
